...
{	
	...
	{	
		echo json_encode(array("$keyName"=>$array,"ResponseCode"=>"$res","ResponseMsg"=> "$responseMessage","Result"=>"$result"));
	}	
	public static function successResponseInArraytwo($keyName, $array,$keyName1, $array1, $res ,$responseMessage,$result)
	{		
		echo json_encode(array("$keyName"=>$array,"$keyName1"=>$array1,"ResponseCode"=>"$res","ResponseMsg"=> "$responseMessage","Result"=>"$result"));
	}
	...
	{		
		echo json_encode(array("$keyName"=>$array,"$keyName1"=>$array1,"$keyName2"=>$array2,"ResponseCode"=>"$res","ResponseMsg"=> "$responseMessage","Result"=>"$result"));
	}
