...
/*	$dataObj = new UserClass();
		    ...
		    {	
	            ...
	            $result3=$dataObj->DeleteActiveorderID($tid);
			}
			*/
				...
				{	
				 	  ...
				 	  if($result2==true)
					  {
	                       ...
	                       $result4=$dataObj->DeleteActiveorderID($tid); 
						    if($result4==true)
		                    {	
						      ResponseClass::ResponseMessage("1","Record Successfully Deleted","True");				
				            }
				            else
				           {
					              ResponseClass::ResponseMessage("2","Record Not Deleted","True");
				           }
						 /*}
					  }
				}*/
