			...
			<tr>
				<td rowspan=2>
					<div style="float: left" class="coverphoto">
						<img src="storelogos/<?php echo $storeID; ?>" class="listResultImage" alt="storelogo" style="width:100px;height:70px;" />
					</div>
				</td>
			...
			<br>
				<hr>
					<br>
						<div id="container">
							<div class="accordion"
								style="width: 50%; margin: auto; min-width: 640px;">
...
while ( $book = mysql_fetch_row ( $bookResults ) ) {
	...
	?>
		<li>
									<table>
										<tr>
											<th colspan=3 style='vertical-align: middle !important;'><a
												href='#' onclick='showBook("<?php echo $bookDialogID; ?>");'><?php echo $title .'</a> <span>' . $bookquantity . '</span>'; ?> 
						<div id='<?php echo $bookDialogID; ?>' style='display: none;'>
														<h4>Book Info</h4>
														<table>
														<td rowspan=2>
					<div style="float: left" class="coverphoto">
						<img src="coverimages/<?php echo $isbn; ?>" class="listResultImage" alt="coverimg" style="width:100px;height:70px;" />
					</div>
				</td>
															<tr>
															...
															<tr>
																<td style='text-align: left; vertical-align: top;'
																	colspan=2><?php echo $editionNumber; ?></td>
															</tr>
															<tr>
																<td style='text-align: left; vertical-align: top;'
																	colspan=2><b>ISBN:</b> <?php echo $isbn; ?></td>
																	<td style='text-align: left; vertical-align: top;'
																	colspan=2><b>Amazon Reviews:</b> <?php echo $rating; ?></td>
															</tr>
															<tr>
																<td style='text-align: left; vertical-align: top;'><b>Publisher:</b></td>
																<td style='text-align: left; vertical-align: top;'
																	colspan=2><?php echo $publisherName; ?></td>
													...
													<table style="text-align: left; font-size: 12px;">
														<tr>
															<td colspan=4 style="text-align: left;">
																...
																id='<?php echo $bookLink; ?>Name'
																value='<?php echo $title; ?>'> <input type="hidden"
																	id='<?php echo $bookLink; ?>ISBN'
																	value='<?php echo $isbn; ?>'> <input type="hidden"
																		id='<?php echo $bookLink; ?>SalePrice'
																		value='<?php echo $saleprice; ?>'> <input
																			type="hidden" id='<?php echo $bookLink; ?>RentPrice'
																			value='<?php echo $rentprice; ?>'> <input
																				type="hidden" id='<?php echo $bookLink; ?>idx'
																				value='<?php echo $idx; ?>'>
														...
														<tr>
															...
															<td colspan=1 style="text-align: right;"><input
																type="text" id='<?php echo $bookLink; ?>Quantity'
																value='1' size=1></td>
														</tr>
														<tr>
															<td style="text-align: left;">Desc</td>
															<td colspan=3 style="text-align: left;"><input
																type="text" id='<?php echo $bookLink; ?>Desc' size=15
																value=''></td>
														</tr>
													</table>
												</div>
