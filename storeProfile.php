...
session_start();
	...
	if(isset( $_FILES['fileToUpload']['name'])){
		...
		$sourcepath = $_FILES['fileToUpload']['tmp_name']; 
	 	...
	 	$filename = $storeID ;
	 	error_log ($filename);
		$targetPath = "storelogos/".$filename; // Target path where file is to be stored
...
// 		$("#loaded-img").attr('src', storelogo);
// 		$("#loaded-img").show();
// 		$('#imageFilename').val(storelogo);
