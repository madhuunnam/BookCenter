...
<form id='borrowForm' method=post action="summaryCart.php">
    <table class="borrowTable">
        <tr>
            <td>  </td>
            <td style="text-align:center;" colspan=3> 按照: <Select id="key" name="key">
                    <option value="privateCallNum">本馆书号</option>
        ...
        <tr>
            ...
            <td  style="text-align:center;" colspan=3> 
                <div class="ui-widget">
                    <label for="libraryName">从图书馆: </label>
        ...
        <tr>
            <td colspan="5" class="submitBtnTd"> <input type="button" name="borrow" id="borrow" value="借出" onclick="javascript:validate();"> 
