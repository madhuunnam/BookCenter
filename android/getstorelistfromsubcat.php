...
require_once __DIR__ . '/db_connect.php';
	...
	$result = mysql_query("SELECT * FROM  stores,inventory,books WHERE stores.storeID=inventory.storeID and inventory.isbn=books.isbn and books.subCat = '$subcat' group by stores.storeName");
//$result = mysql_query("SELECT * FROM  stores WHERE subCat = '$subcat'");
$storelist = array();
if (!empty($result)) {
