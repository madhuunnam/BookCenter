...
bible=new Array("A. Bibles", "B. Biblical Studies", "C. Biblical Reference", "D. Old Testment", "E. Mose's Books", "F. History Books", "G. Wisdom Literature", "H. Prophecy Books", "I. New Testment", "J. Jesus, Gospel, Acts", "K. Paul's Letters", "L. Common Letters", "M. Revelation", "N. Apochropha");
theology=new Array("A. General", "B. Angelology and Demonology", "C. Anthropology", "D. Apologetics", "E. Christology", "F. Doctrinal", "G. Eclesilogogy", "H. Eschatology", "I. Ethics", "J. History Theology", "K. Liberation Theology", "L. Mariology", "M. Pneumatology", "N. Process Theology", "O. Soteriology", "P. Systematic", "Q. Theological Thoughts");
...
christianministry=new Array("A. General", "B. Adult", "C. Care", "D. Children", "E. Couseling and Recovery", "F. Discipleship", "G. Education", "H. Evangelism", "I.  Leadership", "J. Missions", "K. Pastoral Resouces", "L. Preaching", "M. Rituals and Practices", "N. Youth");
...
cddvdother=new Array("A. General", "B. Audio Tapes", "C. Vedio Tapes", "D. Bible on CD", "E. Children's Tapes, CDs, DVDs", "F. Christian Literature and Fiction", "G. Computer Software and other media", "H. Family", "I.  Holidays Music", "J. Hymnals", "K. Hymns Video/ Karaoke, Songs", "L. Playings/Instruments", "M. Sermons", "N. Testimonials");


BiblicalStudies=new Array("a. General", "b. Biblical Criticism, Interpretation", "c. Exegesis and Hermenetics ");
BiblicalReference=new Array("a. General", "b. Commentary", "c. Concordance", "d. Dictionary", "e. Atlas", "f. Handbooks", "g. Language Study");
MosesBooks=new Array("a. Genesis", "b. Exodus", "c. Leviticus", "d. Numbers", "e. Deuteronomy");
HistoryBooks=new Array("a. Joshua", "b. Judges", "c. Ruth", "d. Samuel 1,2", "e. Kings 1,2", "f. Chronicles 1,2", "g. Ezra", "h. Nehemiah", "i. Esther");
WisdomLiterature=new Array("a. Job", "b. Psalms", "c. Proverbs", "d. Ecclesiastes", "e. Song of Solomon");
ProphecyBooks=new Array("a. Isaiah", "b. Jeremiah", "c. Lamentations", "d. Ezeckiel", "e. Daniel", "f. Minor Prophets");
JesusGospelActs=new Array("a. Matthew", "b. Mark", "c. Luke", "d. John", "e. Acts");
PaulsLetters=new Array("a. Romans", "b. Corinthians 1,2", "c. Galatians", "d. Philippians", "e. Ephesians", "f. Colossians", "g. Thessalonians 1,2", "h. Timothy 1, 2", "i. Titus", "j. Philemon");
CommonLetters=new Array("a. Hebrews", "b. James", "c. Peter 1,2", "d. John 1, 2, 3", "e. Jude");
Apologetics=new Array("a. General", "b. Other religions", "c. Cults", "d. Science", "e. Philosophy and Humanities", "f. Culture");
TheologicalThoughts=new Array("a. General", "b. Calvinism", "c. Arminianism", "d. Covernant", "e. Times", "f. Catholic", "g. Liberal", "h. New Orthodoxy", "i. Conservative, evangelical");
Education=new Array("a. General", "b. Adults", "c. Children and Youth");
Biography=new Array("a. General", "b. Biblical", "c. Modern American", "d. Modern Other Contries", "(ancient in history periods)");
Denominations=new Array("a. General", "b. Amish", "c. Angelican", "d. Baptist", "e. Calvinist", "f. Catholic", "g. Christain Science", "h. Episcopalian", "i. Jehovah's witness", "j. Lutheran", "k. Menonite", "l. Methodist", "m. Mormon", "n. Orthodox", "o. Pentecostal and Chrismatic", "p. Presbyterian", "q. Protestant", "r. Quaker", "s. Unitarian", "t. United Church of Christ");
...
function populateSelect(){
	...
	if(cat=='C.ChristianLife'){
		christianlife.forEach(function(t) {
            $('#bookSubCategory').append('<option>'+t+'</option>');
        });
    }
    
	if(cat=='D.ChristianMinistry'){
			...
			<table id="resultTable">
				...
				<tr>
					...
					<td><select id="bookCategory" name="category">
							...
							<option value="C.ChristianLife">C. Christian Life</option>
							<option value="D.ChristianMinistry">D. Christian Ministry</option>
							<option value="E.Church">E. Church and Church History</option>
							<option value="F.CD">F. CD/DVD/Other</option>
					</select></td>
