    	...
    	alert("Do you want to generate new ISBN");
             ...
             url: "generateISBN.php",
               ...
               if (responseJSON['error'] != undefined) {
                   alert("Error occured while generating new ISBN");
               }
               else {
            	...
            	<?php
                    ...
                    if ($title == null || $isbn == null || $author == null || $bookSubCategory == null || $bookCategory == null) {
                            ...
                            $sql = "INSERT INTO `books`(`title`, `insertDate`, `isbn`, `isbn10`, `author`, `publisherName`, 
                                    ...
                                    `fromBackCover`, `productFormatDetail`, `productDimensions`, `shippingWeight`, `pages`) VALUES ('" 
                                    . $title . "', CURRENT_DATE, '" . $isbn . "','" . $isbn13 . "','" . $author . "','" . $publisher . "','" 
                                    . $bookCallNumber . "','" . $bookSubTitle . "','" . $bookAltTitle . "','" . $audience . "','" . $bookLanguage . "','" 
                                    . $bookEditionType . "','" . $bookEdition . "','" . $bookAmazonStar . "','" . $bookAmazonReview . "','" . $bookAmazonURL 
                                    . "','" . $bookCategory . "','" . $bookSubCategory . "','" . $bookSubSubCategory . "','" . $bookPublishedYear . "','" 
                                    . $bookKeywords . "','" . $bookContent . "','" . $bookFromBackCover . "','" . $bookProductFormatDetails . "','" 
                                    . $bookProductDimensions . "','" . $bookShippingWeight . "','" . $bookPages . "')";
                            echo 'alert("0--00");';
                            error_log($sql);
                            ...
                            if (mysql_fetch_row ( $result_indb )) {
                                    ...
                                    if (! $result) {
                                            ...
                                            echo 'window.location.href = "insertBook.php";';
                                    }
                            }
                            mysql_close($dbconn);
                    }
...
<body>
	...
	<div class="container" id="insertbook" align="center">
        ...
        <form id="insertBookForm" name="insert_book_form" action = "InsertBook.php"
                 method="POST">
                <table id="resultTable">
                        ...
                        <tr>
                                        ...
                                        <td> <button id="reqISBN" name="reqISBN" onclick="generateISBN();"> Request ISBN </button></td>
                        </tr>
