...
<head>
	...
	<script type="text/javascript">
		function sendToForgotPassword() {
			window.location.href = 'forgotPasswordCN.php?type=' + $('#loginType:checked').val();
		}
	...
	<div id='tableContainer' style="width:800px; margin:0 auto; margin-top:	3%;">
		...
		<form method='post' action='LoginCN.php'>
			<table id='loginTable' style="width:100%; margin:35px;" >
				<tr >
					<th  id='left'>
						<input type="radio" id="loginType" checked name="loginType" value="Customer"> 客户
					</th>
					<th>
						<input type="radio" id="loginType" name="loginType" value="Store"> 馆员
					</th>
					<th  id='right'>
						<input type="radio" id="loginType" name="loginType" value="Admin"> 网主
					</th>
				</tr>
				<tr>
					<td id='left'>
					...
					<td id='right' class="smallFont">
						新用户? <a class="anchor" href="Signup.php" id="sign-up" class="ybtn ybtn-primary">注册</a>
					</td>
				</tr>
				...
				<tr>
					...
					<td id='right'>
						<a class="anchor" href="#" onclick="sendToForgotPassword()">忘记或改变密码?</a>
					</td>
				</tr>
				<tr >
					<td>
					...
					<td>
						<input type="submit" value="提交" id='loginBtn' class="ybtn ybtn-small">
					</td>
					<td>
					</td>
				</tr>
