...
<div align="center" style='margin:20px;'>
	<a class="menulink topNav roundedLeftBottom" href="insertOrgan.php" >Add to Directory</a>
...
<div align="center" class='grayNavBar' style="margin-top:10px;">
	<nav>
		...
		?>
			...
			<li class="first"><a class="menulink" href="ProcureBooks.php">Procure</a></li>
			...
			<li class="first"><a class="menulink" href="storeStatistics.php">Statistics</a></li>
		...
		?>
			...
			<li class="first"><a class="menulink" href="message.php">Messages</a></li>
		...
		<?php
			...
			if  (!isset($_SESSION['type']) || (isset($_SESSION['type']) && 
                                $_SESSION['type'] !=='Store' && $_SESSION['type'] !=='Customer' && $_SESSION['type'] !=='Admin')) {
		?>
