...
function populateSelect(){
    ...
    function insertBook() {
        ...
        $('#insertBookForm').submit(); // added 8-11-15
    }
    	...
    	<?php
            ...
            if ($title == null || $isbn == null || $author == null || $bookSubCategory == null || $bookCategory == null) {
                    ...
                    $sql = "INSERT INTO `books`(`title`, `insertDate`, `isbn`, `isbn10`, `author`, `publisherName`, 
                            `callNum`, `subTitle`, `altTitle`, `audience`, `language`, `editionType`, `edtionNumber`, `amzonStar`, 
        ...
        <form id="insertBookForm" name="insert_book_form"
                ...
                <table id="resultTable">
                        ...
                        <tr>
                                        ...
                                        <td> <button id="reqISBN" name="reqISBN" onclick="javascript:genISBN();"> Request ISBN </button></td>
                        </tr>
