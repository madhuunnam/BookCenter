...
bible=new Array("A. Bibles", "B. Biblical Studies", "C. Biblical Reference", "D. Old Testment", "E. Mose's Books", "F. History Books", "G. Wisdom Literature", "H. Prophecy Books", "I. New Testment", "J. Jesus, Gospel, Acts", "K. Paul's Letters", "L. Common Letters", "M. Revelation", "N. Apochropha", "O. General");
...
ProphecyBooks=new Array("a. Isaiah", "b. Jeremiah", "c. Lamentations", "d. Ezeckiel", "e. Daniel", "f. Minor Prophets", "g. Major Prophets", "h. General");
JesusGospelActs=new Array("a. Matthew", "b. Mark", "c. Luke", "d. John", "e. Acts", "f. General");
PaulsLetters=new Array("a. Romans", "b. Corinthians 1,2", "c. Galatians", "d. Ephesians", "e. Philippians", "f. Colossians", "g. Thessalonians 1,2", "h. Timothy 1, 2", "i. Titus", "j. Philemon", "h. General");
CommonLetters=new Array("a. Hebrews", "b. James", "c. Peter 1,2", "d. John 1, 2, 3", "e. Jude", "f. General");
...
function populateSelect(){
	...
	if(cat=='ChristianLife'){
		christianlife.forEach(function(t) {
            $('#bookSubCategory').append('<option>'+t+'</option>');
        });
    }
    
	if(cat=='ChristianMinistry'){
			...
			<table id="resultTable">
				...
				<tr>
					...
					<td><select id="bookCategory" name="category">
							...
							<option value="Bible">A. Bible</option>
							<option value="Theology">B. Theology</option>
							<option value="ChristianLife">C. Christian Life</option>
							<option value="ChristianMinistry">D. Christian Ministry</option>
							<option value="Church">E. Church and Church History</option>
							<option value="CD">F. CD/DVD/Other</option>
					</select></td>
