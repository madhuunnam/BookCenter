...
<br>
	    ...
	    <form id='insertForm' method='post' action='insertOrgan.php'  enctype="multipart/form-data">
...
<br>
		...
		<tr>
                    ...
                    <td colspan="1"><input type=text id="addrL1" name="addrL1" size=30/></td>
                ...
                <tr>
                    ...
                    <td colspan="1"><input type=text id="addrL2" name="addrL2" size=30/></td>
                    <th><div align ="right">Homepage</div></th>
                    <td colspan="2"><input type=text id="website" name="website" size=30/></td>
                </tr>
		...
		<tr>
                ...
                <td><input type="text" id="workshipTime" name="workshipTime"/></td>
                <th><div align ="right">Prayer Time</div></th>
                <td><input type="text" id="prayerTime" name="prayerTime"/></td>

                <th><div align ="right">Bible Study Time</div></th>
                <td> <input type="text" id="bibleStudyTime" name="bibleStudyTime"/></td>
                </tr><tr>
                
                    <th><div align ="right">Sunday School Time</div></th>
                    <td> <input type="text" id="sunSchoolTime" name="sunSchoolTime"/></td>
                    ...
                    <th><div align ="right">Another Meeting</div></th>
                    <td> <input type="text" id="meetingName1" name="meetingName1"/></td>
                    <th><div align ="right">Meeting Time</div></th>
                    <td> <input type="text" id="meetingTime1" name="meetingTime1"/></td>
