					...
					<div id="tabs">
										...
										// if($cateogryID != -1)
										{
											...
											while ( $subcattabs = mysql_fetch_row ( $subCatsSQLResults ) ) {
												...
												$getbooksForSubCat = "select B.title,B.author,I.quantity,B.isbn,I.privateCallNum,B.translator,B.editionType,B.editionNumber,B.amazonStar,B.amazonReviews,B.category,B.subcat,B.publisherName,B.amazonRevLink,S.storeID, S.storeName,I.idx,B.pubDate,B.pages,I.bookCondition,I.holderID from Inventory I, Books B, Stores S where B.isbn = I.isbn and S.storeID = I.storeID and B.category = '" . $cat . "'" . " and B.subCat = '" . $tab . "'";
												...
												while ( $bookRow = mysql_fetch_row ( $booksForSubCatSQLResults ) ) {
													...
													echo "<tr>";
													echo "<td>";
													echo "<img src='coverimages/" . $isbn . "' class='listResultImage' alt='coverimg' style='width:90px;height:120px;' />";
													echo "</td>";
													echo "<td>";
													echo "<table  border =0>";
