    ...
    <div id="displayDiv<?php echo $row['tid'] ?>" class='transaction' style="display:None">
      <table style="text-align: left; " border="1" cellpadding="2" cellspacing="2">
        <tbody>
          ...
          <tr>
            <td style="font-size:1em !important; text-align: center !important;" colspan=2><br>
            <form method='post' action='customerActiveOrders.php'>
                <input type='hidden' name='tid' value='<?php echo $row['tid']; ?> '>
                <input type='hidden' name='action' value='received'>
                <input type='submit' name='Submit' class='submit' value='I am at the library and selfcheckout now'>
                </form></td>
          </tr>
          <tr>
              <td>
...
<table>
  ...
  <tr>
      <form method='get' action='homepageCN.php'>
            <input type='submit' name='Submit' class='submit' value='回首页'>
       </form></td>
  </tr>
</table>
</body>
