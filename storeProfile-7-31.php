...
<head>
	...
	<script type="text/javascript">
		...
		function PrintNewLabels(){
			alert("PrintNewLabels");
			/* Transfer data from newLabels.txt to copyofnewLabels.txt 
				Now open the contents of newLabelsCopy.txt in a word doc
				to allow the user to print the callNumbers.
			 */
			 $.ajax({
		            method: "POST",
