...
<div align="center" class='grayNavBar' style="margin-top:10px;">
	<nav>
		...
		?>
			...
			<li class="first"><a class="menulink" href="ProcureForm.php">Procure</a></li><br>
			<li class="first"><a class="menulink" href="InsertBook.php">Insert Books</a></li>
                        <li class="first"><a class="menulink" href="updateBookForm.php">Update Books</a></li>
                        <li class="first"><a class="menulink" href="InsertCampbook.php">输入中文书籍</a></li>
