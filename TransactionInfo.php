...
<!--         <tr> -->
        ...
        <tr>
            ...
            <td> <?php echo $resultRow['transTime'] ?></td>
            
            <th> Type:</th>
            <td> <?php echo $resultRow['type'] ?></td>
         ...
         <tr>
            ...
            <td> <?php echo $resultRow['msgToCust'] ?></td>
            
            <th> Units Ordered:</th>
            <td> <?php echo $resultRow['unitsOrdered'] ?></td>
          </tr>
          <tr>  
            <th> Message to Store:</th>
            <td> <?php echo $resultRow['msgToStore'] ?></td>
