    ...
    <script type="text/javascript">
        ...
        function returnBooks() {
            ...
            if (returnItemsCount > 0) {
                ...
                window.location.href='homepageCN.php';
            }
        }
    </script>
</head>
...
<form method=post action="customerOrderHistory.php">
    ...
    <tbody>
    <tr>
      <th style="vertical-align: top;">书名<br>
      </th>
      <th style="vertical-align: top;">图书馆<br>
      </th>
      <th style="vertical-align: top;">借出日期<br>
      </th>
      <th style="vertical-align: top;">到期日期<br>
      </th>
      <th style="vertical-align: top;">Tid<br>
      </th>
      </th>
      <th style="vertical-align: top;">续借<br>
      </th>
    </tr>
    <?php
    ...
    <tr>
        ...
        <td colspan=2>
          Just return your books! <button name="Go" type="button" onclick="returnBooks();">完成</button><br>
        </td>
    </tr>
</tbody>
</table>
