...
<div align="center" class='grayNavBar' style="margin-top:10px;">
	<nav>
		...
		?>
			<li class="first"><a class="menulink" href="">Chineese</a></li>
			<li class="first"><a class="menulink" href="">Android App</a></li>
		<?php
			}
		...
		?>
			...
			<li class="first"><a class="menulink" href="">Partner</a></li>
