...
$(document).ready(function(){
	...
	$( ".displayLinkClass" ).click(function() {
		...
		var $msgRowID = $(this).closest('tr').find('input[name = "msgID"]');
                $sel = $(this).closest('tr').find('select');
                    //alert($sel.attr("name"));
                    //alert($sel.find('option:selected').text());
                $(this).closest('tr').find('input[name="messageID"]').val($msgRowID.attr("value"));
                $(this).closest('tr').find('input[name="chosenStatus"]').val($sel.find('option:selected').text());
                alert($(this).closest('tr').find('input[name="messageID"]').val());
                alert($(this).closest('tr').find('input[name="chosenStatus"]').val());
...
<?php
		...
		echo "<td><select class = 'statusChoiceClass' name = 'Status_dropdown'>";
            ...
            <input type='hidden' id = 'messageID" .$i ."' name='messageID' /> 
            <input type='hidden' id = 'chosenStatus" .$i ."' name='chosenStatus' /> 
