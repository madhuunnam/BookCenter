...
<body>
	...
	<table> 
		...
		<br />
		<br />
		<th>Batch Shelf entire store </th>
		
		<td><input type="button" id="batchMode" name="batch" value="Shelf Now" onclick="javascript:batchShelfing();">
					</td>
		<td><input type="button" id="printLabel" name="printLabel" value="Print Labels" onclick="javascript:PrintLabels();">
					</td>
		</tr>
		<tr>
			<th> </th>
