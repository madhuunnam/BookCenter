...
<div align="center" style='margin:20px;'>
	<a class="menulink topNav roundedLeftBottom" href="try1.php" >加入教會機構名錄</a>
		<a class="menulink topNav" href="LookupDirectory.php">查詢教會機構名錄</a>
		<?php
...
<div align="center" class='grayNavBar' style="margin-top:10px;">
	<nav>
		...
		?>
			...
			<li class="first"><a class="menulink" href="AboutCN.php">關於</a></li>
			<li class="first"><a class="menulink" href="insertformCN.php">聯絡</a></li>
		<?php
			}
		?>
		</ul>
