...
/* Show screen#4 (search result page containing booklist) when user searches for a book by entering ISBN or Title or Author or Callnum */
	...
	$sql = 'select B.title as title, B.author as author, B.isbn as isbn, B.callNum as callNum, B.category as category, B.subCat as subCat, B.subSubCat as subSubCat, B.publisherName as publisherName, B.edtionNumber as editionNumber, B.amzonStar as amazonStar, B.pubDate as pubDate, B.pages as pages, ';
	...
	while ( $store = mysql_fetch_row ( $k ) ) {
		...
		echo "<tr class='" . $count20 . "Class " . $count40 . "Class " . $count60 . "Class results'>
					...
					<table >
						...
						<tr>
							<td style='text-align:left;' colspan=2><b> Edition: <b> $editionNumber</td>
                                                        <td style='text-align:left;' colspan=2><b> Edition Type: <b> $store[26]</td>
						</tr>
						<tr>
							...
							<td style='text-align:left;' colspan=2><b>Amazon Rating:</b> $amazonStar</td>
                                                ...
                                                <tr>
							<td style='text-align:left;' colspan=2><b>Amazon </b> $store[27]</td>
			...
			<td>
				<table>
					<tr>
						<td colspan=2 style='text-align:center;'>$amazonStar</td>
					</tr>
				</table>
			</td>
