...
<h2> Procure Books </h2>
	...
	<table> 
		...
		<tr>
			<th> Agent Name </th>
			<td> <input type="text" name="Agent" id="Agent" placeholder = "Agent Name"> </td>
		</tr>
		<tr>
			<th> ISBN * </th>
		...
		<td> <input type="button" name="Cancel" value = "Cancel" id="cancel" onclick="javascript:takeToHomePage();"> </td>
		<td> <input type="button" name="done" id="done" value="Done" > </td>
		</tr>
